...
- 本清单中的开发环境已经完成。
- 因为现在写代码时主要卡在“思路到语法/函数”的映射，所以先完成 7 天 Python 基础桥接，再回到 30 道 Python 练习。
...
- [ ] 周一：Python 基础桥接 Day 2；阅读《利用Python进行数据分析》第 92-99 页。
- [ ] 周二：Python 基础桥接 Day 3；阅读《利用Python进行数据分析》第 100-108 页。
- [ ] 周三：Python 基础桥接 Day 4；阅读《利用Python进行数据分析》第 109-123 页。
- [ ] 周四：Python 基础桥接 Day 5；阅读《利用Python进行数据分析》第 124-135 页。
- [ ] 周五：Python 基础桥接 Day 6；阅读《利用Python进行数据分析》第 136-150 页。
- [x] 周六：配置 Git 仓库、notebook 环境和目录结构。
- [ ] 周日：Python 基础桥接 Day 7；阅读《利用Python进行数据分析》第 151-168 页；写周复盘和下周风险清单。
